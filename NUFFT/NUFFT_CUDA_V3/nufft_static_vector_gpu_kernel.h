 ...
 */
/*
* nufft_static_vector_gpu_kernel.: header to declare kernels used by GPU NUFFT calculation 
*/
...
//not sure if this can be shared between scalar and vector method. Ben, 02/22/14.
