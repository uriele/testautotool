 ...
 */
/*
* field_static_scalar_gpu.h: class declaration of Class FieldStaticScalarGpu
*/
#ifndef _FIELD_STATIC_SCALAR_GPU
#define _FIELD_STATIC_SCALAR_GPU
#include "field_static_scalar.h"
#include "field_gpu.h"
#include <cmath>
namespace NBODYFAST_NS{
class FieldStaticScalarGpu : public FieldStaticScalar, public FieldGpu
{
public:
	FieldStaticScalarGpu(){}
	FieldStaticScalarGpu(class NBODYFAST *n_ptr);
	virtual ~FieldStaticScalarGpu();
