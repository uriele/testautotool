 ...
 */
/*
* direct_static_scalar_gpu.cu: class definition of Class DirectStaticScalarGpu
*/
#include "nbodyfast.h"
#include "gpu.h"
...
DirectStaticScalarGpu :: DirectStaticScalarGpu(class NBODYFAST *n_ptr) : DirectStaticScalar(n_ptr)
{
	field_static_scalar_gpu = dynamic_cast<FieldStaticScalarGpu*>(n_ptr->field);
}
DirectStaticScalarGpu :: ~DirectStaticScalarGpu()
{
}
int DirectStaticScalarGpu :: execution()
{
...
int DirectStaticScalarGpu :: execution_single()
{
	...
	cudaFuncSetCacheConfig(direct_onfly_static_scalar_single, cudaFuncCachePreferShared);
	// calling direct calculation kernel
	direct_onfly_static_scalar_single<<<_dim_grid, _dim_block>>>(field_static_scalar_gpu->d_src_coord[0], field_static_scalar_gpu->d_obs_coord[0], field_static_scalar_gpu->d_src_amp[0], field_static_scalar_gpu->d_field_amp[0], _d_test, problem_size, Field::epsilon());
...
int DirectStaticScalarGpu :: execution_multi()
{
	return 0;
}
}